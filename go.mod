...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.56.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/elasticloadbalancingv2 v1.18.18 // indirect
